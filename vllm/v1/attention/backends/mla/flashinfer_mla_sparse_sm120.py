...
class FlashInferMLASparseSM120Impl(MLAAttentionImpl[FlashInferMLASparseMetadata]):
    ...
    def __init__(
        ...
        **mla_args,
        ...
        # on sm120 against a bf16 reference (rel err ~2.7%, pure fp8
        # quantization noise).
